...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#efe8d8] text-[#0a0a0a]">
      ...
      {/* HERO */}
      <section ref={heroRef} className="relative min-h-screen pt-4 md:pt-6 pb-20 flex flex-col">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 md:px-10 flex flex-col mt-auto">
          <motion.div
          ...
          <h1 className="display text-[3.5rem] sm:text-8xl lg:text-[11rem] leading-[0.85] font-black tracking-tighter" data-testid="hero-headline">
            ...
            <div className="reveal-mask block">
              <motion.span
                ...
                className="block"
              >collab <span className="italic text-[#e63946]">starts</span></motion.span>
            </div>
            <div className="reveal-mask block">
              <motion.span
                initial={{ y: "110%" }} animate={{ y: 0 }}
                ...
                className="block"
              >here<span className="text-[#e63946]">.</span></motion.span>
            </div>
          </h1>
      ...
      {/* CATEGORIES */}
      <section className="bg-[#e63946] text-[#efe8d8] py-12 md:py-20 relative" data-testid="categories-section">
        <div className="max-w-7xl mx-auto px-5 md:px-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
          <div>
            <div className="mono text-[10px] uppercase tracking-[0.3em] text-[#efe8d8]/70 mb-2">§ 01 — Browse by craft</div>
            <h2 className="display text-4xl md:text-6xl lg:text-7xl font-black leading-[0.9]">
      ...
      {creators.length > 0 && (
        <section className="bg-[#0a0a0a] text-[#efe8d8] py-8 md:py-14 relative overflow-hidden" data-testid="featured-section">
          <div className="absolute top-4 left-6 mono text-[10px] uppercase tracking-[0.3em] text-[#e63946]">§ 02 — Featured</div>
          <div className="max-w-7xl mx-auto px-5 md:px-10">
      ...
      <section className="max-w-7xl mx-auto px-5 md:px-10 py-12 md:py-20" data-testid="about-section">
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-start mb-16">
          ...
          <div className="space-y-5 pt-1">
            ...
            <p className="text-base md:text-lg text-[#0a0a0a]/80 leading-relaxed">
              We started with a simple observation that India has millions of creators who are seriously good at what they do, and thousands of brands that genuinely want to work with them, but no infrastructure that makes it feel human. Noctra is that infrastructure.
            </p>
          ...
          {[
            {
              title: "For Brands",
              bg: "bg-[#f4c542]",
              desc: "Browse verified creators by niche, city, engagement rate and budget.",
              cta: "Start as brand →",
              to: "/auth?role=brand",
            },
            {
              ...
              bg: "bg-[#e63946]",
              fg: "text-[#efe8d8]",
              desc: "Get discovered by brands that fit your audience. Apply to campaigns, negotiate terms, and get paid once the brand approves your content.",
              cta: "Join as creator →",
              to: "/auth?role=creator",
            },
            {
